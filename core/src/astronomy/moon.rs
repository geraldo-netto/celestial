...
mod tests {
    ...
    #[test]
    fn lunar_position_matches_regression_vectors() {
        let cases = [
            (
                2_400_000.5,
                0.011_286_832_122_735,
                0.037_778_405_109_688,
                383_097.298_907_837,
            ),
            (
                2_448_724.5,
                2.324_125_628_786_796,
                -0.056_358_797_406_331,
                368_409.633_145_717,
            ),
            (
                2_451_545.0,
                3.897_647_267_117_302,
                0.090_255_844_863_867,
                402_444.749_620_383,
            ),
            (
                2_463_456.789,
                3.606_340_107_420_493,
                -0.010_251_762_655_028,
                397_716.670_516_548,
            ),
            (
                2_500_000.5,
                0.776_032_097_696_699,
                -0.050_759_222_495_492,
                372_822.986_712_207,
            ),
        ];
        for (jde, lon, lat, dist_km) in cases {
            let pos = lunar_position(jde);
            assert!((pos.lon - lon).abs() < 1e-12);
            assert!((pos.lat - lat).abs() < 1e-12);
            assert!((pos.dist_km - dist_km).abs() < 1e-6);
        }
    }
}
