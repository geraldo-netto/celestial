...
pub fn planet_mean_elements(body: i32, jd_et: f64) -> Option<PlanetElements> {
    let t = (jd_et - J2000) / 36525.0;
    // Table format: [L0,L1, a0,a1, e0,e1, i0,i1, Om0,Om1, w0,w1]
    let tab: Option<[f64; 12]> = match body {
        1 => Some([
            // Mercury
            252.250_324_4,
            149_472.674_1,
    ...
    let [l0, l1, a0, a1, e0, e1, i0, i1, om0, om1, w0, w1] = tab?;
