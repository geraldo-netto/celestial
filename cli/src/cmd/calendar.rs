...
mod tests {
    ...
    #[test]
    fn jewish_modes() {
        assert!(run(CalendarArgs {
            tradition: Tradition::Jewish(JewishArgs {
                year: Some(2024),
                json: false
            })
        })
    ...
    fn easter_modes() {
        assert!(run(CalendarArgs {
            tradition: Tradition::Easter(EasterArgs {
                year: Some(2025),
                all: false,
                json: false
            })
    ...
    fn islamic_modes() {
        assert!(run(CalendarArgs {
            tradition: Tradition::Islamic(IslamicArgs {
                year: Some(2024),
                convert: None,
                json: false
            })
    ...
    fn panchanga_modes() {
        assert!(run(CalendarArgs {
            tradition: Tradition::Panchanga(PanchangaArgs {
                date: "2451545.0".into(),
                festivals: false,
                year: None,
                json: false
    ...
    fn vesak_modes() {
        assert!(run(CalendarArgs {
            tradition: Tradition::Vesak(VesakArgs {
                year: Some(2024),
                uposatha: false,
                json: false
            })
    ...
    fn nowruz_modes() {
        assert!(run(CalendarArgs {
            tradition: Tradition::Nowruz(NowruzArgs {
                year: Some(2024),
                bahai: false,
                json: false
            })
    ...
    fn islamic_convert_bad_and_easter_all_text() {
        let _ = run(CalendarArgs {
            tradition: Tradition::Islamic(IslamicArgs {
                year: None,
                convert: Some("not-a-date".into()),
                json: false,
            }),
        });
        assert!(run(CalendarArgs {
